...
class HelloFresh:
    ...
    def func_get_entry_details(self, entry):
        return {
            ...
            'image': "https://img.hellofresh.com/w_1200,q_auto,f_auto,c_fill,fl_lossy/hellofresh_s3" + entry['imagePath'],
            'cuisines': [i['name'] for i in entry['cuisines']]
        }

    def func_get_access_token(self):
        r = requests.get('https://www.hellofresh.com/recipes')
    ...
    def func_get_data(self):
        ...
        url = 'https://www.hellofresh.com/gw/recipes/recipes/search'
        ...
        feed_entries = [self.func_get_entry_details(entry) for entry in feed]
...
hello_fresh.loaded_feed = hello_fresh.func_get_data()