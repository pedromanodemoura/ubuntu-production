...
class GreenChef:
    ...
    def func_get_entry_details(self, entry):
        return {
            ...
            'image': "https://img.greenchef.com/w_1200,q_auto,f_auto,c_fill,fl_lossy/hellofresh_s3" + entry['imagePath'],
            'cuisines': [i['name'] for i in entry['cuisines']]
        }

    def func_get_access_token(self):
        r = requests.get('https://www.greenchef.com/weekly-menu')
    ...
    def func_get_data(self):
        ...
        url = 'https://www.greenchef.com/gw/menus-service/menus'
...
greenchef.loaded_feed = greenchef.func_get_data()